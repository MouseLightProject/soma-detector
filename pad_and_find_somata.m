...
% [xyz_from_guess_index, voxel_count_from_guess_index, sqrt_condition_number_from_guess_index, max_intensity_from_guess_index] = ...
    ...
    [xyz_from_guess_index, ...
     ...
     max_intensity_from_guess_index] = ...
        find_somata_in_uint16_stack(padded_substack_yxz, ...
                                              ...
                                              substack_shape_xyz, ...
                                              parameters) ;
        % xyz_from_guess_index are in the coordinate system of the full stack
end
