...
%     serial_voxel_index_of_interest = sub2ind(size(padded_stack_yxz), jik1_of_interest(1), jik1_of_interest(2), jik1_of_interest(3)) ;
    ...
    if isempty(component_properties_as_struct) ,
        ...
        raw_component_features_from_label = ...
            arrayfun(...
                @(s)(compute_derived_component_features(s, padded_substack_yxz, padded_background_substack_yxz, padded_substack_origin_xyz, origin_at_zoom_level_xyz, spacing_at_zoom_level_xyz, x_grid_yxz, y_grid_yxz, z_grid_yxz)), ...
